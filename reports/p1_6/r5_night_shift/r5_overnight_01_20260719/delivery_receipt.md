...
- Package SHA-256: `D19AB2C9BCB811C63523B057F0E503BE448E81568D0098917FEF2D6E6918CD8C`
...
| Report-layer closure | `f89a3ab71fa8dbb43d004f01bd19b64111721e80` | local and remote byte-identical; CI success in run `29667752060` |

The final metadata-correction commit is intentionally identified by the target branch HEAD after
this receipt is committed; its exact local/remote parity is verified after the final push. This
avoids placing a self-referential commit SHA inside the commit it identifies.
...
| Readout A/B determinism | readout, JSON and next queue equal | `.local/night_shift/receipts/readout_determinism.json`; stable receipt `fd80a1b6e3bbc6df07300426eb805cd2bafe3bcee4599f4dd84b332d59b0f3d9` |
...
| Scope guard | pass; 0 forbidden; 0 tracked `.local`; 0 tracked BF2 outputs | `.local/night_shift/scope_audit.json`; audit SHA-256 `0fbdeb0d37c86b835b7042823c5895c060f787dee7dfb5bc63cafa9ffa3519a0` |
