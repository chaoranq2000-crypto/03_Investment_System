...
单个 episode 使用 `portfolio.trade_episode.v1`，集合使用
`portfolio.trade_episode.collection.v1`，validator 使用
`portfolio.trade_episode.validation.v1`，builder 版本为 `p2c_v1`。
